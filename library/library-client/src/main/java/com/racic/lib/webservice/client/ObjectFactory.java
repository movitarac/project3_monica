 ...
 * generated in the com.racic.lib.webservice.endpoint package. 
...
public class ObjectFactory {
    ...
    private final static QName _FindAllResponse_QNAME = new QName("http://endpoint.webservice.lib.racic.com/", "findAllResponse");
    private final static QName _FindMemberByEmailResponse_QNAME = new QName("http://endpoint.webservice.lib.racic.com/", "findMemberByEmailResponse");
    private final static QName _IsValidUserResponse_QNAME = new QName("http://endpoint.webservice.lib.racic.com/", "isValidUserResponse");
    private final static QName _FindAll_QNAME = new QName("http://endpoint.webservice.lib.racic.com/", "findAll");
    private final static QName _FindByUsernameAndPassword_QNAME = new QName("http://endpoint.webservice.lib.racic.com/", "findByUsernameAndPassword");
    private final static QName _IsValidUser_QNAME = new QName("http://endpoint.webservice.lib.racic.com/", "isValidUser");
    private final static QName _FindByUsernameAndPasswordResponse_QNAME = new QName("http://endpoint.webservice.lib.racic.com/", "findByUsernameAndPasswordResponse");
    private final static QName _FindMemberByEmail_QNAME = new QName("http://endpoint.webservice.lib.racic.com/", "findMemberByEmail");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.racic.lib.webservice.endpoint
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.webservice.lib.racic.com/", name = "findAllResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.webservice.lib.racic.com/", name = "findMemberByEmailResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.webservice.lib.racic.com/", name = "isValidUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.webservice.lib.racic.com/", name = "findAll")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.webservice.lib.racic.com/", name = "findByUsernameAndPassword")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.webservice.lib.racic.com/", name = "isValidUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.webservice.lib.racic.com/", name = "findByUsernameAndPasswordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.webservice.lib.racic.com/", name = "findMemberByEmail")
